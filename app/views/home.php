        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card h-100">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h5 class="card-title m-0 me-2">عدد الاقسام</h5>
              <div class="dropdown">
            ...
            <div class="card-body pb-0">
              <div class="d-flex align-items-center">
                <span class="badge bg-primary me-3"><?php echo $params['countCategories']?></span>
                <span>قسم</span>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="card h-100">
            <div class="card-header">
              <h5 class="card-title mb-3">عدد الكتاب</h5>
              <small class="badge bg-primary"><?php echo $params['countAuthors'] ?></small>
              <span> كاتب</span>
            </div>
        ...
        <div class="col-12 col-md-12 col-lg-4">
          <div class="row">
            <div class="col-sm-6 col-md-3 col-lg-6 mb-4">
              <div class="card">
                <div class="card-body pb-0">
                  <span class="d-block fw-semibold mb-1">عدد المستخدمين</span>
                  <h3 class="badge bg-primary"><?php echo $params['usersCount'] ?> </h3> مستخدم
                </div>
            ...
            <div class="col-sm-6 col-md-3 col-lg-6 mb-4">
              <div class="card">
                <div class="card-body">
                  ...
                  <span class="fw-semibold d-block mb-1">الطلبات الجديدة</span>
                  <h4 class="badge bg-danger">0</h4>
                  ...
                  <div class="d-flex justify-content-between">
                    <div class="d-flex flex-column">
                      <div class="card-title mb-auto">
                        <h5 class="mb-0">عدد الكتب</h5>
                        <small>كل المنتجات</small>
                      </div>
                      <div class="chart-statistics">
                        <h3 class="badge bg-danger mb-1"><?php echo $params['booksCount'] ?></h3> كتاب
                      </div>
                    </div>
                    <div class="">
                      <h1 class="fs-2 mb-4">النشطة</h1>
                      <p class="badge bg-danger"><?php echo $params['countBooksIsActive'] ?></p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row row-bordered g-0">
              <div class="col-md-6">
                <div class="card-header d-flex align-items-center justify-content-between mb-4">
                  <h5 class="card-title m-0 me-2">بعض الاقسام</h5>
                  <div class="dropdown">
                ...
                <div class="card-body">
                  <ul class="p-0 m-0">
                  <?php foreach($params['getCategories'] as $cat){ ?>
                    <li class="d-flex mb-4 pb-1">
                      <div class="avatar flex-shrink-0 me-3">
                        ...
                        <div class="me-2">
                          ...
                          <small class="text-muted d-block mb-1"><?php echo $cat['name'] ?></small>
                        </div>
                        <div class="user-progress d-flex align-items-center gap-1">
                          <span class="fw-bold"><?php echo $cat['id'] ?></span>
                        </div>
                      </div>
